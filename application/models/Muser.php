 <?php
    ...
    class Muser extends CI_Model
    {
        ...
        public function login($inputan)
        {
            ...
            if (!empty($user)) {
                if ($user['level'] == 'admin') {
                    ...
                    $this->session->set_userdata("petugas", $user);
                    return "petugas";
                } elseif ($user['level'] == 'kepala_lapas') {
                    $this->session->set_userdata("kepala_lapas", $user);
                    return "kepala_lapas";
                } else {
                    return "gagal";
                }
        ...
        function simpan_user($inputan)
        {
            ...
            $this->db->insert('datapetugas', $inputan);
        }

 
        function detail_user($id_user)
        {
            $this->db->where('id_pet', $id_user);
            $ambil = $this->db->get('datapetugas');
        ...
        function hapus_user($id_user)
        {
            ...
            $this->db->where('id_pet', $id_user);
            $this->db->delete('datapetugas');
        }

        function hitung_user()
        {
            $this->db->select('id_pet');
            $this->db->from('datapetugas');
            $query = $this->db->get();
