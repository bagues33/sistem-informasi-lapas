<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-1 mb-2" href="<?= base_url('petugas/beranda'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('petugas/datatahanan'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('petugas/datasel'); ?>">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Data Sel</span></a>
            </li>
            ...
            <!-- Nav Item - Permintaan Barang -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('petugas/datatahananmasuk'); ?>">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Data Tahanan Masuk</span></a>
            </li>
            ...
            <!-- Nav Item - Permintaan Barang -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('petugas/dataremisi'); ?>">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Data Remisi</span></a>
            </li>
            ...
            <!-- Nav Item - Permintaan Barang -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('petugas/datapelatihan'); ?>">
                    <i class="fas fa-fw fa-folder"></i>
            ...
            <!-- Nav Item - Permintaan Barang -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('petugas/datatahanankeluar'); ?>">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Data Tahanan Keluar</span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="text-left mt-2">
                        <p class="mb-0 font-weight-bold">Petugas
                        </p>
                        <p>
