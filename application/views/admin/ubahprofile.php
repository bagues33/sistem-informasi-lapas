    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    <label>Phone</label>
                    <input type="text" class="form-control" id="phone" name="telpet" placeholder="phone" value="<?= $datauser['telpet']; ?>">
                </div>
                <div class="col-md-6 form-group">
                    <label>Jabatan</label>
                ...
                <div class="col-md-6 form-group">
                    <label>Alamat</label>
                    <!-- <input type="text" class="form-control" id="alamat" name="alpet" placeholder="Alamat" value="<?= $datauser['alpet']; ?>"> -->
                    <textarea class="form-control" id="alamat" name="alpet"><?= $datauser['alpet']; ?></textarea>
                </div>
                <div class="col-md-6 form-group">
