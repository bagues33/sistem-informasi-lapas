...
<div class="col-md-12">
    <div class="card shadow mb-4">
            ...
            <div class="row">
                ...
                <div class="col md-8">
                    <table class="table table-borderless text-secondary">
                        <tr>
                            <td>Nama &emsp;&emsp;: <?= $admin['nama_pet']; ?></td>
                        </tr>
                        <tr>
                            <td>Jabatan &emsp;: <?= $admin['jabatan']; ?></td>
                        </tr>
                        <tr>
                            <td>Phone &emsp;&emsp;: <?= $admin['telpet']; ?></td>
                        </tr>
                        <tr>
                            <td>Role &emsp;&emsp;: <?= $admin['level']; ?></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="card-footer text-md-right">
            <a href="<?= base_url("admin/beranda/ubahprofile/$admin[id_pet]") ?>" class="btn btn-primary btn-icon btn-icon-split btn-sm">
