...
class Managemenuser extends CI_Controller
{
    ...
    public function tambah()
    {
        ...
        $this->form_validation->set_rules('nama_pet', 'Nama', 'required|alpha_numeric_spaces');
        $this->form_validation->set_rules('alpet', 'Alamat', 'required');
        $this->form_validation->set_rules('telpet', 'Phone', 'numeric|max_length[15]');
